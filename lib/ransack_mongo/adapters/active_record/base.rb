    ...
    module ActiveRecord
      module Base
        ...
        def ransacker(name, opts = {}, &block)
          self._ransackers = _ransackers.merge name.to_s => RansackMongoer
        ...
        # RansackMongoable_attributes, by default, returns all column names
        ...
        # RansackMongoable_associations, by default, returns the names
        ...
        # RansackMongoable_scopes, by default, returns an empty array
