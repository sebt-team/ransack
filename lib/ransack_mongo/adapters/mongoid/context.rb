require 'ransack_mongo/context'
require 'polyamorous'

module RansackMongo
  module Adapters
    module Mongoid
      class Context < ::RansackMongo::Context
        ...
        def table_for(parent)
          # parent.table
          RansackMongo::Adapters::Mongoid::Table.new(parent)
        end
        ...
        def lock_association(association)
          warn "lock_association is not implemented for RansackMongo mongoid adapter" if $DEBUG
        end

        def remove_association(association)
          warn "remove_association is not implemented for RansackMongo mongoid adapter" if $DEBUG
        end
