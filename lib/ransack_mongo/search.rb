require 'ransack_mongo/nodes'
require 'ransack_mongo/context'
RansackMongo::Adapters.object_mapper.require_search
require 'ransack_mongo/naming'
    ...
    def build(params)
      collapse_multiparameter_attributes!(params).each do |key, value|
        if ['s'.freeze, 'sorts'.freeze].freeze.include?(key)
          ...
          add_scope(key, value)
        elsif !RansackMongo.options[:ignore_unknown_conditions]
