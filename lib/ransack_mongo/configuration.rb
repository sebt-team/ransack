require 'ransack_mongo/constants'
...
module RansackMongo
  module Configuration
    ...
    # Another name can be set using the `search_key` option with RansackMongo
    ...
    # By default RansackMongo ignores errors if an unknown predicate, condition or
    ...
    # By default, RansackMongo displays sort order indicator arrows in sort links.
